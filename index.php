...
<main class="row">
	...
	<h3 class="categories-title">Категории</h3>
		<ul class="list">
			<?php
			$query_categories = 'SELECT * FROM categories ORDER BY category';
			$result_categories = mysqli_query($dbConnect, $query_categories);
			...
			while (list($id, $category) = mysqli_fetch_array($result_categories, MYSQLI_NUM)) {
